 ...
 *
 * MySQL language file for GenSynth.
 *
...
$language_data = [
    ...
    'COMMENT_MULTI'          => ['/*' => '*/'],
    'CASE_KEYWORDS'          => GenSynth::OPT_CAPS_NO_CHANGE,            // @@@ would be nice if this could be defined per group!
    'QUOTEMARKS'             => ["'", '"', '`'],
    ...
    'NUMBERS'                =>
        GenSynth::NUMBER_INT_BASIC |
        GenSynth::NUMBER_OCT_PREFIX |
        GenSynth::NUMBER_HEX_PREFIX |
        GenSynth::NUMBER_FLT_NONSCI |
        GenSynth::NUMBER_FLT_SCI_SHORT |
    ...
    'OBJECT_SPLITTERS'       => [],
    'REGEXPS'                => [],
    'STRICT_MODE_APPLIES'    => GenSynth::NEVER,
    'SCRIPT_DELIMITERS'      => [],
